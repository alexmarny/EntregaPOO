...
public class App {
    public static void main(String[] args) throws Exception {
		...
		int ritmoLectura = 1;
		// Variable para almacenar el número de libros que el usuario desea almacenar
		int N = 0;
		...
		do {
			...
			case 1:
				...
				N = Esdia.readInt("Introduce el número de libros que deseas almacenar: ");
				almacen = new Almacen(N);
